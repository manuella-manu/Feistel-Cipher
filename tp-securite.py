...
def main():
    ...
    key = input()
    while len(key) < 8:
        print("La taille de la clé doit être égal à 8")
        key = input()
    print("Donnez la fonction H de permutation")
    h = input()
    while len(h) < 8:
        print("La taille doit être de égal à 8")
        h = input()
    decg = 0
    decd = 0
    ...
    n = input()
    while len(n) < 8:
        print("La taille doit être égal à 8")
        n = input()
    choix = -1
    while choix != 1 and choix != 2:
        print("Voulez-vous chiffrer ou dechiffrer?")
        print("tapez 1 pour dechiffrer et 2 pour chiffrer")
        choix = int(input())
    print("Entrez la permutation P de 4 bits")
    p = input()
    while len(p) < 4:
        print("La taille doit être égal 4")
        p = input()
    print("Entrez la clé de permutation pour chiffrer ou dechiffrer")
    keyc = input()
    while len(keyc) < 8:
        print("La taille doit être égal 8")
        keyc = input()
    tkey = kgen.split(",")
    if choix == 2:
        pn = permut(n, keyc)
